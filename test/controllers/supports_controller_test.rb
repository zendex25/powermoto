...
class SupportsControllerTest < ActionController::TestCase
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post :create, support: { body: @support.body, contact: @support.contact, email: @support.email, name: @support.name }
    end
  ...
  test "should update support" do
    patch :update, id: @support, support: { body: @support.body, contact: @support.contact, email: @support.email, name: @support.name }
    assert_redirected_to support_path(assigns(:support))
  end
